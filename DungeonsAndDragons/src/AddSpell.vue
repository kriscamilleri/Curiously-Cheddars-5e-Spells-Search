<template>
    <div>
        <b-alert :variant="dismissableAlertType" dismissible :show="showDismissibleAlert" @dismissed="showDismissibleAlert=false">
            {{dismissableAlertMessage}}
        </b-alert>
        <b-modal title="Add Spell" id="spellModal" size="lg" class="modal-full" ok-variant="success" ok-title="Save" method="post" @ok="submitForm">
            <div class="row mb-3">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <b-input-group left="@" class="mb-2 mr-sm-2 mb-sm-0">
                        <b-input id="levelsInput" name="levelsInput" placeholder="ex. 9" type="number" min="0" max="9" />
                    </b-input-group>
                    <br>
                </div>
                <div class="col-md-12">
                    ...
                    <b-input-group left="@" class="mb-2 mr-sm-2 mb-sm-0 max-width-override">
                        <textarea rows="3" name="descInput" max-rows="8" class="form-control" id="descInput" placeholder="ex. <p>You create three magic darts. Each dart hits a creature you can see. A dart deals 1d4+1 force damage. The darts all strike simultaneously and you can direct them to hit one creature or several.</p>" />
                    </b-input-group>
                    <br>
                </div>
                <div class="col-md-12">
                    ...
                    <b-input-group left="@" class="mb-2 mr-sm-2 mb-sm-0  max-width-override">
                        <textarea rows="3" name="higherLevelsInput" max-rows="8" class="form-control" id="higherLevelsInput" placeholder="ex. <p>The spell creates one more dart for each slot above 1st.</p>" />
                    </b-input-group>
                    <br>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <b-input-group left="@" class="mb-2 mr-sm-2 mb-sm-0">
                        <b-form-select class="mb-2 mr-sm-2 mb-sm-0" :value="false" :options="{ true: 'True', false: 'False' }" id="somaticInput" name="somaticInput" />
                    </b-input-group>
                    <br>
                </div>
                <div class="col-md-6">
                    ...
                    <b-input-group left="@" class="mb-2 mr-sm-2 mb-sm-0">
                        <b-form-select class="mb-2 mr-sm-2 mb-sm-0" :value="false" :options="{ true: 'True', false: 'False' }" id="verbalInput" name="verbalInput" />
                    </b-input-group>
                    <br>
                </div>
                <div class="col-md-6">
                    ...
                    <b-input-group left="@" class="mb-2 mr-sm-2 mb-sm-0">
                        <b-form-select class="mb-2 mr-sm-2 mb-sm-0" :value="false" :options="{ true: 'True', false: 'False' }" id="ritualInput" name="ritualInput" />
                    </b-input-group>
                    <br>
                </div>
                <div class="col-md-6">
                    ...
                    <b-input-group left="@" class="mb-2 mr-sm-2 mb-sm-0">
                        <b-form-select class="mb-2 mr-sm-2 mb-sm-0" :value="false" :options="{ true: 'True', false: 'False' }" id="concentrationInput" name="concentrationInput" />
                    </b-input-group>
                    <br>
                </div>
                <div class="col-md-6">
                    ...
                    <b-input-group left="@" class="mb-2 mr-sm-2 mb-sm-0">
                        <b-form-select class="mb-2 mr-sm-2 mb-sm-0" :value="false" :options="{ true: 'True', false: 'False' }" id="materialCostInput" name="materialCostInput" />
                    </b-input-group>
                    <br>
                </div>
                <div class="col-md-6">
                    ...
                    <b-input-group left="@" class="mb-2 mr-sm-2 mb-sm-0">
                        <b-input id="materialInput" name="materialInput" placeholder="ex. A red dragon's scale." />
                    </b-input-group>
                    <br>
                </div>
                <div class="col-md-6">
                    ...
                    <b-input-group left="@" class="mb-2 mr-sm-2 mb-sm-0">
                        <b-input id="pageInput" name="pageInput" placeholder="ex. 145" type="number" min="0" max="1000" />
                    </b-input-group>
                    <br>
                </div>
            </div>
...
export default {
    ...
    methods: {
        submitForm(e) {
            ...
            let higherLevelsInput = document.getElementById('higherLevelsInput').value;
            ...
            let materialCostInput = document.getElementById('materialCostInput').value;
            let materialInput = document.getElementById('materialInput').value;
            let pageInput = document.getElementById('pageInput').value;
            let concentrationInput = document.getElementById('concentrationInput').value;
